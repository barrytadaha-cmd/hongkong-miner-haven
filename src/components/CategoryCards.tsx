              ...
              <Link to={category.path}>
                <Card className="group h-full hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-border hover:border-primary/30 bg-gradient-to-br from-card to-card/80">
                  <CardContent className="p-3 md:p-4 flex flex-col items-center text-center">
                    <motion.div className="w-full aspect-square mb-3 md:mb-4 bg-gradient-to-br from-muted to-muted/50 rounded-lg flex items-center justify-center overflow-hidden relative" whileHover={{
                  rotateZ: 2
                }}>
                      ...
                      <img src={category.image} alt={category.name} className="w-3/4 h-3/4 object-contain group-hover:scale-110 transition-transform duration-500" />
                    </motion.div>
